    ...
    const simulateDownload = () => {
      ...
      const interval = setInterval(() => {
        ...
        if (progress > 100) {
          ...
          alert(`Download complete! (${activeTab} - This is a simulation)`)
        }
        ...
        {videoInfo && activeTab !== 'copyright' && (
          <div className="mt-8 bg-white p-6 rounded-lg shadow">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
              ...
              <Button onClick={handleDownload} className="bg-green-500 hover:bg-green-600 text-white" disabled={isDownloading}>
                {isDownloading ? 'Downloading...' : `Download ${activeTab === 'mp3' ? 'MP3' : activeTab === 'mp4' ? `MP4 (${quality})` : activeTab === 'shorts' ? 'Short' : 'Video'}`}
              </Button>
            </div>
            {isDownloading && (
              <div className="mt-4">
